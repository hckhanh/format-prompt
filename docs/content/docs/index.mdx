...
2. **Schema validation**:
   ...
   - Built-in support for [Standard Schema](https://standardschema.dev) specification
...
<Cards>
  ...
  <Card title="Schema Validation" icon={<Lock />}>
    Built-in support for [Standard Schema](https://standardschema.dev) - compatible with Zod, Valibot,
    ArkType, and more
  </Card>
  <Card title="Flexible" icon={<Wrench />}>
    Works with any schema library that implements [Standard Schema](https://standardschema.dev) for maximum
    flexibility
  </Card>
