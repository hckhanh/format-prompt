...
You'll also need a schema validation library that implements [Standard Schema](https://standardschema.dev):
...
what-the-fetch works with any [Standard Schema](https://standardschema.dev) implementation:
